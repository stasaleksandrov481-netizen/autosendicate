...
import { PixiCarEditor } from './PixiCarEditor';
...
export function TuningAtelierBridge(){
  ...
  const addDecal=(assetId:string)=>{
    ...
    const decal:DecalConfig={id:crypto.randomUUID(),assetId,x:122,y:78,scale:1,rotation:0,zIndex:20+config.decals.length,tint:'#ffffff',opacity:1};
